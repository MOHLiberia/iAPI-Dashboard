export const mainMenuList = [
    ...
    },
    {
        ...
        subMenu: [
            ...
            {
                name: 'Add DHIS2 Instance',
                to: '/dashboard/dhis2/add',
                icon: 'tabler:plus',
                permission: 'add_dhis2_instance',
                role: ''
            },
        ]
    },
    ...
    },
    {
        ...
        subMenu: [
            ...
            {
                name: 'Organizations',
                to: '/dashboard/metadata/organizations',
            ...
            {
                name: 'Departments',
                to: '/dashboard/metadata/departments',
            ...
            {
                name: 'Permissions',
                to: '/dashboard/metadata/permissions',
