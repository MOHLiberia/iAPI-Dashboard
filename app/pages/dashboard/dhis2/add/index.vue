                ...
                <Form v-slot="$form" :resolver @submit="submit">
                    <div class="grid md:grid-cols-2 gap-3 mb-4">
                        <div class="grid md:grid-cols-3 md:col-span-2 gap-3">
                            <FormField v-slot="$field" name="name" initialValue="" class="space-y-1 md:col-span-2">
                            ...
                            <FormField v-slot="$field" name="shortName" initialValue="" class="space-y-1 md:col-span-1">
                                <FloatLabel variant="on">
                        ...
                        <div class="grid md:grid-cols-3 md:col-span-2 gap-3">
                            <FormField v-slot="$field" name="description" initialValue="" class="space-y-1 md:col-span-2">
                                <FloatLabel variant="on">
                            ...
                            <FormField v-slot="$field" name="" initialValue="" class="space-y-1">
                                <FloatLabel variant="on" class="md:col-span-1">
                                    <Select id="type" :options="DHIS2versions" optionLabel="name" optionValue="id" fluid showClear />
                        ...
                        <FormField v-slot="$field" name="apiURL" initialValue="" class="space-y-1">
                            <FloatLabel variant="on">
                        ...
                        <div class="flex  gap-2">
                            ...
                            <Message v-if="$form.active?.invalid" severity="error" size="small" variant="simple">{{ $form.active.error?.message }}</Message>
                        </div>
                    </div>
